...
<!--<![endif]-->
<!-- BEGIN HEAD -->
<?php $theme_assets = url('/assets'); ?>
<head>
    <meta charset="utf-8" />
    <title>BD Cash Payment - @yield('title')</title>
    ...
    <link href="{{$theme_assets}}/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css" />
    ...
    <link href="{{$theme_assets}}/pages/css/login-2.min.css" rel="stylesheet" type="text/css" />
...
<div class="copyright hide"> 2016 &copy; . </div>
<!-- END LOGIN -->
<!--[if lt IE 9]>
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="{{$theme_assets}}/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="{{$theme_assets}}/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
...
<script src="{{$theme_assets}}/pages/scripts/login.min.js" type="text/javascript"></script>
